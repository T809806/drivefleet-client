...
This project is built using the MERN stack and focuses on clean UI, authentication with JWT cookies, and dynamic data handling.
...
- Clean and modern UI
- Real-world car rental functionality
- Secure backend with authentication
- Search & filter powered by MongoDB queries
